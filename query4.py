from Query4_Index import *
from datetime import date
import dbm
import collections
import struct

query4_index_dbm = dbm.open('q44','r')
...
def binary_input(block ,record):
    file_open_pointer_4 = open("sorted.bin", 'rb')
    maxSizePerBlock = 4096
    data = file_open_pointer_4.read(maxSizePerBlock*block)
